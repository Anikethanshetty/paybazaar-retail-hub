  ...
  return (
    <div className="flex min-h-screen w-full bg-background">
      ...
      <div className="flex-1">
        {/* Header */}
        <header className="bg-slate-800 text-white p-4 border-b">
        ...
        <main className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="shadow-lg">
              <CardHeader>
                <CardTitle className="text-lg text-slate-800">Export Data</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <Button
                  onClick={() => handleDownload('csv')}
                  className="w-full bg-gradient-to-r from-slate-800 to-green-600 hover:from-slate-700 hover:to-green-500 text-white font-medium py-2.5"
                >
