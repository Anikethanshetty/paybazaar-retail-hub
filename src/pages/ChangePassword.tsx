        ...
        <main className="flex-1 p-6 space-y-8 overflow-auto">
          ...
          <div className="paybazaar-gradient rounded-xl p-6 text-white shadow-md">
            ...
            <p className="text-white/80 text-sm max-w-2xl leading-relaxed">
              Update your login credentials and security PIN for enhanced account protection.
            </p>
          </div>
            ...
            <Card className="shadow-lg border-0 bg-card">
              ...
              <CardContent>
                <form onSubmit={handlePasswordSubmit} className="space-y-6">
                  ...
                  <Button type="submit" className="w-full paybazaar-gradient font-semibold">
                    Change Password
                  </Button>
                </form>
              </CardContent>
            ...
            <Card className="shadow-lg border-0 bg-card">
              ...
              <CardContent>
                <form onSubmit={handlePinSubmit} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleInputChange("oldMpin", e.target.value)}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleInputChange("newMpin", e.target.value)}
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="confirmMpin" className="text-sm font-semibold">
                      Confirm MPIN
                    </Label>
                    <div className="relative">
                      <Key className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                      <Input
                        ...
                        onChange={(e) => handleInputChange("confirmMpin", e.target.value)}
